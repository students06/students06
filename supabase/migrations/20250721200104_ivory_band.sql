-- قاعدة بيانات نظام إدارة الحضور الشامل - النسخة المصححة والنظيفة
-- تاريخ الإنشاء: 2025-01-21
-- متوافقة 100% مع MySQL/MariaDB
-- تم إصلاح جميع مشاكل الكلمات المحجوزة والتوافق
...
CREATE TABLE attendance (
    ...
    INDEX idx_date (DATE(record_time))
);
...
-- رسالة النجاح
SELECT 'تم إنشاء قاعدة البيانات المصححة والنظيفة بنجاح!' as message,
       'متوافقة 100% مع MySQL/MariaDB' as compatibility,
       'تم إصلاح جميع مشاكل الكلمات المحجوزة' as fixes,
